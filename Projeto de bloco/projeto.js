...
/* Função 1
 Separar cada array em:
 alunos: { notas: [nota1, nota2, nota3, nota4] }
   Função 2
 Pegar média de cada aluno e adicionar ela a
   Função 3
 Atribuir status ao aluno ex {aluno: {notas: [nota1, nota2, nota3, nota4], media: x, status: aprovado/reprovado/recuperação}}
*/

/* 
  Rever se notas em array é melhor que em JSON
*/

/* Lógica do programa 
  
   fazer um for loop nas notasAlunosMatriz e reformatar para JSON
   fazendo com que a primeira parte seja sempre o nome do aluno e o resto da array vire uma array separada com o nome notas
...
function retornaStatus(objeto, menores, maiores) {
 ...
 // Se for maior que notaMin e menor do que nota Max
console.log(notaMin)
console.log(notaMax)
